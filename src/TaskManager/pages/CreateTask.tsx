...
export default function CreateTask() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-indigo-100 animate-fade-in">
      <div className="w-full max-w-2xl p-8 bg-white rounded-xl shadow-lg animate-fade-in-up">
        <h2 className="text-2xl font-bold text-center text-indigo-700 mb-8 drop-shadow">
          Create New Task
        </h2>
